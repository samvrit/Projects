void change_dir()
{
      ...
      {
        if(straight==1) reverse1();
        else if(right==1) { if(coordinate==1) right1(); else sharp_right(); }
        else if(left==1) { if(coordinate==1) left1(); else sharp_left(); }
        else if(reverse==1) go_straight(); 
      }
